 ...
 */
public class lastweekvisitor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet lastweekvisitor</title>");            
            out.println("</head>");
          ...
          try
            {
                ...
                PreparedStatement stmt=con.prepareStatement("select * from visitor where Date >= CURDATE() - 6 && Date <= CURDATE()");
