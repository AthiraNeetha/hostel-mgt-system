 ...
 */
public class onemonthvisitor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet onemonthvisitor</title>");            
            out.println("</head>");
          ...
          try
            {
                ...
                PreparedStatement stmt=con.prepareStatement("select * from visitor where Date >= CURDATE() - 30 && Date <= CURDATE()");
                ...
                out.println("<table border=1 width=80% height=50% align=center>"
                    + "<tr><th>APPLICATION NO</th><th>VISITOR NAME </th><th>ADDRESS</th><th>DATE</th><th>TIME</th></tr>");
               
                String sname , add , date , time ,app;
                while(rs.next())
                {
                    app  = rs.getString(1);
