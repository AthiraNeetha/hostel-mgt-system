 ...
 */
public class visitoradd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet visitoradd</title>");            
            out.println("</head>");
            out.println("<body>");
            try
            {
                ...
                com.mysql.jdbc.Connection con=(com.mysql.jdbc.Connection) DriverManager.getConnection("jdbc:mysql://localhost/hostel","root","");  
                    ...
                    java.sql.Timestamp sqlTime=new java.sql.Timestamp(date.getTime());
                     PreparedStatement stmt1=con.prepareStatement("insert into visitor values(?,?,?,?,?)");
                     ...
                     out.println("<script>alert('Your details are recorded');</script>");
