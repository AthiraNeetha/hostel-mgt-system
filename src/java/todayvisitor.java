 ...
 */
public class todayvisitor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet todayvisitor</title>");            
            out.println("</head>");
             ...
             try
            {
                ...
                PreparedStatement stmt=con.prepareStatement("SELECT * FROM visitor WHERE Date =CURDATE()");
