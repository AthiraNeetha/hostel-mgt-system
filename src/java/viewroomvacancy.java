 ...
 */
public class viewroomvacancy extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet viewroomvacancy</title>");            
            out.println("</head>");
          ...
          try
            {
                ...
                int i=0;
                out.println("<center><h1 style=color:Navy blue>ROOM VACANCY</h1></center>");
                out.println("<center>");
                out.println("<table border=1 width=80% height=50% align=center>"
                    + "<tr><th>ROOM NO </th><th>GRADUATION TYPE</th><th>BATCH</th><th>CAPACITY</th><th>VACANCY</th></tr>");
               
                String room , grad , year , total ,vac ;
                while(rs.next())
                {
                    room = rs.getString(1);
                    grad = rs.getString(2);
